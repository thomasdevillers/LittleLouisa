  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-6">
        ...
        <div className="md:col-span-5 grid grid-cols-2 gap-6">
          {[
            ...
            { src: "/photos/2ndbedroom.jpg", alt: "Second bedroom", label: "Second Bedroom" },
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-6">
        <div className="md:col-span-5 grid grid-cols-2 gap-6">
          {[
            ...
            { src: "/photos/fireplace.jpg", alt: "Fireplace", label: "Outdoor Fireplace" },
          ].map((p) => (
            <div key={p.src} className="aspect-square overflow-hidden group relative cursor-pointer" onClick={() => openAt(p.src)}>
              <Image src={p.src} alt={p.alt} fill className="object-cover transition-transform duration-1000 group-hover:scale-105" sizes="(max-width: 768px) 50vw, 20vw" />
              <div className="absolute bottom-4 left-4 text-white text-[9px] uppercase tracking-widest font-bold">{p.label}</div>
          ...
          <div className="aspect-square overflow-hidden group relative col-span-2 cursor-pointer" onClick={() => openAt("/photos/fireplace2.jpeg")}>
            <Image src="/photos/fireplace2.jpeg" alt="Fireplace detail" fill className="object-cover transition-transform duration-1000 group-hover:scale-105" sizes="(max-width: 768px) 100vw, 40vw" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          { src: "/photos/outsitearea.jpg", alt: "Outside seating area", label: "Patio" },
          { src: "/photos/outsidearea2.jpg", alt: "Outside area with seating", label: "Al Fresco" },
          { src: "/photos/outside.jpg", alt: "Little Louisa exterior", label: "The Cottage" },
        ].map((p) => (
